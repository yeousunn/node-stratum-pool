...
var GwMaker = require('./usc/gwMaker.js')
...
var pool = module.exports = function pool(options, authorizeFn){
    ...
    /**Initialize GwMaker
    * Parameters: 
    * @uscdRpcAddr node RPC address
    * @uscdRpcPort node RPC port
    * */
    var gwMaker = new GwMaker("localhost","58858");
    ...
    _this.daemon.cmd('getblocktemplate',
        ...
        function(result){
            if (result.error){
                ...
                gwMaker.makeRawGwMsg(function(rawgw){
                    console.log("rawgw::", rawgw);
                });
